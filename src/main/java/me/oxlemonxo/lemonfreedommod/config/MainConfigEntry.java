...
import me.oxlemonxo.lemonfreedommod.config.MainConfigEntry;

public enum MainConfigEntry
{
    ...
    private MainConfigEntry(Class<?> type, String configName)
    {
        this.type = type;
    ...
    {
        return  LemonFreedomMod.plugin().config;
    }

    public static MainConfigEntry findConfigEntry(String name)
    {
        name = name.toLowerCase().replace("_", "");
        for (MainConfigEntry entry : values())
        {
